...
typedef NS_ENUM(NSInteger, SPTPNGenericAdapterState) {
...
@property (strong) NSTimer *validationTimeoutTimer;
...
{
    self.validationTimeoutTimer = [NSTimer scheduledTimerWithTimeInterval:SPTPNTimeoutInterval target:self selector:@selector(validationDidTimeOut) userInfo:nil repeats:NO];
}
